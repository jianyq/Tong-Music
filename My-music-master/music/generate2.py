...
def main(text_start, generate_length, mothod):
    device='0,1,2,3'
    ...
    if mothod == 0:
        model_path=r"F:\ThatsGood\Deepcamp\场景描写生成与人物描写生成\GPT2-Chinese-master\model\整体模型"
    elif mothod == 1:
        model_path=r"F:\ThatsGood\Deepcamp\场景描写生成与人物描写生成\GPT2-Chinese-master\model\场景模型"
    elif mothod == 2:
        model_path=r"F:\ThatsGood\Deepcamp\场景描写生成与人物描写生成\GPT2-Chinese-master\model\人物模型"
    else:
        return "error"
    prefix=text_start

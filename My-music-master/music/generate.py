...
import argparse
import sys
sys.path.append(r'E:\Tong-music\HelloWorld\HelloWorld')
from tqdm import trange
from transformers import GPT2LMHeadModel
from tokenizations import tokenization_bert
# text_start = input("请输入想开始的主题+主要内容(如：童年的我住在乡下：)：")
def is_word(word):
...
def main(text_start):
    ...
    topk=8
    topp=0
    tokenizer_path=r'E:/Tong-music/My-Music-master/music/cache/vocab.txt'
    model_path=r'E:/Tong-music/My-Music-master/music/model/final_model'
    prefix=text_start
    ...
    # parser.add_argument('--topk', default=32, type=int, required=False, help='最高几选一')
    ...
    # parser.add_argument('--prefix', default=text_start, type=str, required=False, help='生成文章的开头')
